...
Route.post("/:id/comment", auth, routeControllers_posts.commentaire);
...
Route.delete("/comment/:id", auth, routeControllers_posts.deleteCommentaire);
Route.get("/comments/post/:id", routeControllers_posts.recupAllCommentOnePost);

// route partage de post
Route.post("/partage/post/:id", auth, routeControllers_posts.partage);
Route.get("/partage/post/:id", routeControllers_posts.recupPartage);
Route.delete("/partage/post/:id", auth, routeControllers_posts.suppUnPartage);
